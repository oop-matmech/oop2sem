package robots.game.ui;

import robots.game.helpz.LoadSave;
import robots.game.objects.Tile;
import robots.game.scenes.Editing;
...
import static robots.game.main.GameStates.MENU;
import static robots.game.main.GameStates.SetGameState;
...
public class Toolbar extends Bar {
    ...
    private void initButtons() {
        ...
        bSave = new MyButton(I18nProvider.getGameMessage("game_save_btn"), 2, 674, 100, 30);
    ...
    private void drawButtons(Graphics g) {
        ...
        bSave.setText(I18nProvider.getGameMessage("game_save_btn"));
        bMenu.draw(g);
        bSave.draw(g);
